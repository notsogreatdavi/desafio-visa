...
def map(request):
    ...
    m = folium.Map(location=[-14.537928336797815, -40.95286772588722], zoom_start=3.5, width='100%', height='100%', tiles='OpenStreetMap')
    ...
    folium.Circle([lat, lng], tooltip=country).add_to(m)
